...
We take security seriously. If you discover a security vulnerability in XIZ Platform, please report it responsibly.
...
- The XIZ Platform desktop application
- The `@xiz-platform/*` npm packages
- Official XIZ Platform repositories
