...
import type { StoredAttachment, StoredMessage } from '@xiz-platform/core/types';
...
import type { Workspace, AuthType } from '@xiz-platform/core/types';
...
const FALLBACK_CONFIG_DEFAULTS: ConfigDefaults = {
  version: '1.0',
  description: 'Default configuration values for XIZ Platform',
  defaults: {
...
export type { StoredAttachment, StoredMessage } from '@xiz-platform/core/types';
