 ...
 * Extracted here so handler code in @xiz-platform/server-core can import
 * from @xiz-platform/shared/protocol without reaching into the app.
 */
...
export { generateMessageId } from '@xiz-platform/core/types'
...
export interface TaskGenerateResult {
  ...
  slug: string
  /** Parsed TaskSpec when valid (consumers cast to TaskSpec from @xiz-platform/shared/tasks). */
  spec?: unknown
...
export interface TaskGetResult {
  slug: string
  validation: TaskValidationResultDto
  /** The parsed TaskSpec (from @xiz-platform/shared/tasks) when valid; consumers cast. */
  spec?: unknown
