...
// System prompt for XIZ Platform context
  ...
  switch (code) {
    ...
    case 'CAPABILITY_UNAVAILABLE':
      return 'No connected desktop client supports browser tools, or no client is currently connected. ' +
        'Ask the user to open this workspace from the XIZ Platform desktop app.';
...
export class PiAgent extends BaseAgent {
  protected backendName = 'XIZ Platform Backend';
  ...
  private handleSubprocessEvent(event: Record<string, unknown>): void {
    ...
    // Feed them through PiEventAdapter to convert to XIZ PlatformEvents.
   ...
   * Uses the canonical registry from @xiz-platform/session-tools-core.
   */
  ...
  protected async *chatImpl(
    ...
    try {
      ...
      const systemPrompt = getSystemPrompt(
        ...
        'XIZ Platform Backend', // backendName
