 ...
 * XIZ Platform's AgentEvent format for UI compatibility.
 *
...
import type { AgentEvent as CraftAgentEvent } from '@xiz-platform/core/types';
import type {
...
/**
 * Maps Pi SDK events to XIZ PlatformEvents for UI compatibility.
 *
 * Event mapping:
...
export class PiEventAdapter extends BaseEventAdapter {
  ...
  /**
   * Adapt a Pi SDK event to zero or more XIZ PlatformEvents.
   */
