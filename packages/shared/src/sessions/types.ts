...
import type { StoredAttachment, MessageRole, ToolStatus, AuthRequestType, AuthStatus, CredentialInputMode, StoredMessage } from '@xiz-platform/core/types';
 ...
 * Re-exported from @xiz-platform/core for convenience
 */
export type { StoredMessage } from '@xiz-platform/core/types';
