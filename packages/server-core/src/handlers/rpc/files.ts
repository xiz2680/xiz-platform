...
import { RPC_CHANNELS, type FileAttachment, type DirectoryListingResult } from '@xiz-platform/shared/protocol'
import type { StoredAttachment } from '@xiz-platform/core/types'
import { readFileAttachment, validateImageForClaudeAPI, IMAGE_LIMITS } from '@xiz-platform/shared/utils'
import { getSessionAttachmentsPath, validateSessionId } from '@xiz-platform/shared/sessions'
import { getWorkspaceByNameOrId } from '@xiz-platform/shared/config'
import { resizeImageForAPI, inspectImageBuffer } from '@xiz-platform/server-core/services'
import { sanitizeFilename, validateFilePath, getWorkspaceAllowedDirs } from '@xiz-platform/server-core/handlers'
