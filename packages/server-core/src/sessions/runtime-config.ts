import type { AgentProvider, LlmAuthType } from '@xiz-platform/shared/agent/backend'
import { isCompatProvider, modelSupportsImages, type LlmConnection } from '@xiz-platform/shared/config'
