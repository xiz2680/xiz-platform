 ...
 * `@xiz-platform/messaging-whatsapp-worker` subprocess.
 *
 ...
 *
 * The worker contract is defined in @xiz-platform/messaging-whatsapp-worker.
...
import {
  ...
  type WorkerCommand,
  type WorkerEvent,
} from '@xiz-platform/messaging-whatsapp-worker'
import type {
  PlatformAdapter,
  PlatformConfig,
  AdapterCapabilities,
