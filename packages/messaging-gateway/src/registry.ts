...
import type { PushTarget } from '@xiz-platform/shared/protocol'
import type { CredentialManager } from '@xiz-platform/shared/credentials'
import type {
  ISessionManager,
...
export interface MessagingGatewayRegistryOptions {
  ...
  whatsapp?: {
    /** Absolute path to the worker entry (packaged/unpacked from @xiz-platform/messaging-whatsapp-worker). */
    workerEntry: string
