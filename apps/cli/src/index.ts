#!/usr/bin/env bun
/**
 * craft-cli — Terminal client for XIZ Platform server.
 *
 * Connects over WebSocket (ws:// or wss://) to a running XIZ Platform server
...
function printHelp(): void {
  process.stdout.write(`craft-cli — Terminal client for XIZ Platform server
