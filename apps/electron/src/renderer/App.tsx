...
import type { SessionDraft, DraftAttachmentRef } from '@xiz-platform/shared/config'
...
import { TooltipProvider } from '@xiz-platform/ui'
...
import { extractWorkspaceSlugFromPath } from '@xiz-platform/shared/utils/workspace-slug'
import { DEFAULT_THINKING_LEVEL } from '@xiz-platform/shared/agent/thinking-levels'
...
export default function App() {
  ...
  // Platform actions for @xiz-platform/ui components (overlays, etc.)
