...
import { PERMISSION_MODE_CONFIG, type PermissionMode } from '@xiz-platform/shared/agent/modes'
...
import { flattenLabels, parseLabelEntry, formatLabelEntry, formatDisplayValue } from '@xiz-platform/shared/labels'
...
export function ActiveOptionBadges({
  ...
  // Show the stacking container when there are labels.
