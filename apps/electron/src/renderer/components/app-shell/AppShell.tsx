...
import { Tooltip, TooltipTrigger, TooltipContent, DocumentFormattedMarkdownOverlay } from "@xiz-platform/ui"
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuSub,
...
import { buildLabelTree, getDescendantIds, getLabelDisplayName, flattenLabels, extractLabelId, findLabelById, sortLabelsForDisplay, matchesLabelFilter } from "@xiz-platform/shared/labels"
import type { LabelConfig, LabelTreeNode } from "@xiz-platform/shared/labels"
...
function AppShellContent({
  ...
  // Grouping mode for chat list. Legacy status grouping falls back to date now
  // that session status UI has been removed.
  ...
  // Index into the matched label results.
