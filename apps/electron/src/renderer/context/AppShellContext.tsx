...
export interface AppShellContextType {
  ...
  getDraftAttachmentRefs: (sessionId: string) => import('@xiz-platform/shared/config').DraftAttachmentRef[]
  ...
  labels?: import('@xiz-platform/shared/labels').LabelConfig[]
  ...
  onSendMessage: (sessionId: string, message: string, attachments?: FileAttachment[], skillSlugs?: string[], badges?: import('@xiz-platform/core').ContentBadge[]) => void
