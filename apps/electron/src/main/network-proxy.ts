...
import { getNetworkProxySettings, setNetworkProxySettings } from '@xiz-platform/shared/config/storage';
import type { NetworkProxySettings } from '@xiz-platform/shared/config/types';
