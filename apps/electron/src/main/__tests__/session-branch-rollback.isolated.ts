...
mock.module('@xiz-platform/shared/config', () => ({
...
mock.module('@xiz-platform/shared/workspaces', () => ({
  loadWorkspaceConfig: () => ({
    defaults: {
      permissionMode: 'ask',
      thinkingLevel: 'medium',
...
mock.module('@xiz-platform/shared/agent', () => ({
...
mock.module('@xiz-platform/shared/agent/backend', () => ({
...
mock.module('@xiz-platform/shared/sources', () => ({
...
mock.module('@xiz-platform/shared/automations', () => ({
...
mock.module('@xiz-platform/shared/sessions', () => ({
  listSessions: () => [],
...
const { SessionManager } = await import('@xiz-platform/server-core/sessions')
