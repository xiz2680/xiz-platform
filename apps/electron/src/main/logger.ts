...
import type {
  ...
  MessagingLogMeta,
  MessagingLogger,
} from '@xiz-platform/messaging-gateway'
...
export const messagingGatewayLogPath = join(configDir, 'logs', 'messaging-gateway.log')
 ...
 */
export const autoUpdateLogPath = join(configDir, 'logs', 'auto-update.log')
