...
echo "=== Building XIZ Platform AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: XIZ-Platform-x86_64.AppImage or XIZ-Platform-aarch64.AppImage
BUILT_APPIMAGE_NAME="XIZ-Platform-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: XIZ-Platform-x64.AppImage, XIZ-Platform-arm64.AppImage
APPIMAGE_NAME="XIZ-Platform-${ARCH}.AppImage"
