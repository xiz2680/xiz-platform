...
echo "=== Building XIZ Platform DMG (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder.yml uses artifactName to output: XIZ-Platform-${arch}.dmg
DMG_NAME="XIZ-Platform-${ARCH}.dmg"
